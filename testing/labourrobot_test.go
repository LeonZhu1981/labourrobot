...
func Test_GoQuery_1(t *testing.T) {
	...
	doc.Find("tr").Each(func(i int, s *goquery.Selection) {
		column0, _ := s.Find("td").Eq(0).Html()
		column1, _ := s.Find("td").Eq(1).Html()
		column2, _ := s.Find("td").Eq(2).Html()
		column3, _ := s.Find("td").Eq(3).Html()

		// column0 := s.Find("td").Eq(0).Text()
		// column1 := s.Find("td").Eq(1).Text()
		// column2 := s.Find("td").Eq(2).Text()
		// column3 := s.Find("td").Eq(3).Text()
